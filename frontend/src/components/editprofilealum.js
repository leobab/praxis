...
import $ from 'jquery';
export default class editprofilealum extends Component {

    state = {

        descripcion: '',
        disponibilidad: ["Seleccionar", "Presencial", "No presencial", "Semi-presencial"],
        experiencia: '',
        estudios: '',
        idiomas: '',
        habilidades: '',
    ...
    onSubmit = async (e) => {
        ...
        const response = await axios.post('http://localhost:5000/alum/completar_registro', formData,
            {
                ...
                <div class="col-lg-12 p-5 text center  ">
                    <div className="card mt-3">
                        <div className="card-body">
                            <h5 className="card-title text-center">Editar perfil alumno</h5>
                            <form className="mt-4" onSubmit={this.onSubmit}>
                                ...
                                <ul class="row list-unstyled" id="containerExperiencia"></ul>
                                ...
                                <div className='row'>
                                    ...
                                    <div className='col-4'>
                                        <h6 class="mt-3 mb-3">Desde </h6>
                                        <div className="form-group">
                                            <div class="md-form ">
                                                <input type="time" id="inputMDEx1" class="form-control" name='alum_d_desde' value={this.state.alum_d_desde} onChange={this.onInputChange} />
                                            </div>
                                        </div>
                                    </div>
                                    <div className='col-4'>
                                        <h6 class="mt-3 mb-3">Hasta </h6>
                                        <div className="form-group">
                                            <div class="md-form ">
                                                <input type="time" id="inputMDEx1" class="form-control" name='alum_d_hasta' value={this.state.alum_d_hasta} onChange={this.onInputChange}/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
